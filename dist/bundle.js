      ...
      items: [
        {
          id: "w1",
          type: "workflow",
          title: "Consultant document review",
          categoryId: "acme",
          priority: "urgent",
          dueDate: "2026-04-11",
          timeNeeded: 120,
          stage: "awaiting",
          stageSentDate: "2026-04-10",
          followUpDays: 5,
        ...
        },
        {
          id: "w2",
          type: "task",
          title: "Respond to client proposal",
          categoryId: "acme",
          priority: "urgent",
          dueDate: TODAY,
          timeNeeded: 60,
          focusBlock: { day: "Today", start: "10:00", end: "11:00" },
          notes: "CC Sarah on reply.",
          done: false
        },
        {
          id: "w3",
          type: "task",
          title: "Send contract to Acme",
          categoryId: "acme",
          priority: "medium",
          dueDate: TODAY,
          timeNeeded: 30,
        ...
        },
        {
          id: "w5",
          type: "task",
          title: "Compile board pack supporting docs",
          categoryId: "board",
          priority: "medium",
          dueDate: "2026-04-15",
          timeNeeded: 60,
...
Notes: ${task.notes}` : ""
  ...
  function parseLocalTime(dateStr, hhmm) {
    return (/* @__PURE__ */ new Date(`${dateStr}T${hhmm}:00`)).getTime();
  }
